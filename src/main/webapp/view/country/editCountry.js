		...
		.ready(
				function() {
					...
					if (data !== null) {
						...
						//alert("In If");
							//jQuery('#editProjectTypeisActive')[0].checked = true;			
							jQuery("#editCountryisActive").prop('checked', true);
						}
						else
						{
						//alert("In else");
						jQuery("#editCountryisActive").prop('checked', false);
						//jQuery('#editProjectTypeisActive')[0].checked = false;			
					...
					jQuery("#saveChanges_btn")
							.click(
									function(e) {
										...
										var isActiveStatus = jQuery('#editCountryisActive').is(':checked') ? countryisActive = "on" : countryisActive = "off";
