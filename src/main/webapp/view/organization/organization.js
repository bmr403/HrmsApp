jQuery(document)
		.ready(
				function() {
					...
					jQuery("#submitChanges_btn")
							.click(
									function(e) {
										...
										var x = document
												.getElementById("gemsCountryMasterId");
										var gemsCountryMasterId = x.innerHTML;
												...
												.ajax({
													...
													data : {
														...
														gemsCountryCode : jQuery(
																'#gemsCountryCode')
																.val(),
														gemsCountryDescription : jQuery('#gemsCountryDescription')
																.val(),
														activeStatus : jQuery(
																'#isActive')
																.val()
					...
					jQuery('#countryCreatedDate_search').datepicker({
						format : "mm/dd/yyyy",
						changeMonth : true,
						changeYear : true
					});
